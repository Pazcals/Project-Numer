...
class Forward_1 extends Component {
    ...
    render() {
        return(
            <div style={{ background: "#FFFF", padding: "30px" ,  marginBlockStart: "2%"}}>
                <h2 style={{ color: "black", fontWeight: "bold" ,fontSize :"30px"}}>Forward Divided-Differences O(h)</h2>
                <Content 
                ...
                >
                        ...
                        >
                            ...
                            <Button id="submit_button" onClick={
                                ...
                                ()=>this.forward_1 (parseInt(this.state.x), parseInt(this.state.h), parseInt(this.state.degree))
