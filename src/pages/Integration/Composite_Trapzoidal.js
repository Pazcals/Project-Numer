...
class Composite_Trapziodal extends Component {
    constructor() {
        super();
        this.state = {
            fx: "",
    ...
    DataBase = async()=>{
        ...
        this.composite_trapzoidal(parseInt(this.state.lower), parseInt(this.state.upper) , parseInt(this.state.n));
    }
	
    render() {
        return(
            <div style={{ background: "#FFFF", padding: "30px" ,  marginBlockStart: "2%"}}>
                <h2 style={{ color: "black", fontWeight: "bold" ,fontSize :"30px"}}>Composite Trapzoidal</h2>
                <Content 
...
export default Composite_Trapziodal